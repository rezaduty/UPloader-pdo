...
<div id="wrapper">
    ...
    if(isset($_GET['id']))
    {
        $o1->check_get($_GET['id']);
        $e=new error;
        $e->login_error('نام کاربری یا رمز عبور اشتباه است');
    }
    ?>
    <form action="check.php" class="form-login" method="post">
        ...
        <div class="inputs">
            <input name="username" type="text" required placeholder="یوزر نیم" />
            <input name="password" type="password" required placeholder="پسورد" />
            ...
            <div class="link-2"><a href="forgot.php">پسوردم را فراموش کردم</a></div>
            <div class="clear"></div>

            <div class="button-login"><input id="send" type="submit" value="ورود" name="send"></div>
        </div>
