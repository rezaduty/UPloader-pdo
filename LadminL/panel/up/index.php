...
<div id="header">
    ...
    <div id="subnav">
        <div class="container_12">
            <div class="grid_12">
                <ul>
                    <li><a href="index.php">اخرین اپلود ها</a> </li>
                </ul>
...
<table>
    ...
    $result=$connect->query("SELECT * FROM upload  ORDER BY ID DESC");
            ...
            <form action="">
                <table id="myTable" class="tablesorter">
                    ...
                    <tr>
                        ...
                        <th style="width:21%">نمای ان</th>
                        <th style="width:13%">حجم</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        ...
                        <td><img width="150px" height="150px" src="<?php echo '../../../up/'.$rows["name"];?>"/></td>
                        <td><?php echo $rows["size"];?></td>
                        <td>
                            <a href="<?php echo "up/delete.php?id=$rows[id]"?>"><img src="../pics/bin.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/bin.gif" width="16" height="16" alt="delete" /></a>
                        </td>
                    </tr>
