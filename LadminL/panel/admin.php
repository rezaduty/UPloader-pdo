...
<table>
    ...
    $result=$connect->query("SELECT * FROM tbl_admin ORDER BY `id` DESC LIMIT ".$start.",".$counter."");
            ...
            <form action="">
                <table id="myTable" class="tablesorter">
                    ...
                    <tr>
                        ...
                        <th style="width:21%">نام</th>
                        <th style="width:13%">نام کاربری</th>
                        <th style="width:13%">رمز عبور</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" />
                            <a href="<?php echo "admin/edit.php?id=$rows[id]"?>"><img src="pics/pencil.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/pencil.gif" width="16" height="16" alt="edit" /></a>
                            <a href="<?php echo "admin/delete.php?id=$rows[id]"?>"><img src="pics/bin.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/bin.gif" width="16" height="16" alt="delete" /></a>
                        </td>
                    </tr>
    ...
    ?>
    <center><a href="admin/insert.php"><button>جدید</button></a></center>
    <?php
