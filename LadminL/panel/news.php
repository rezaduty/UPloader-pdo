            ...
            <div class="grid_12">
                <div id="logo">
                    <ul id="nav">
                        ...
                        <li id="current"><a href="../panel">صفحه اصلی</li>                        
...
<table>
        ...
        <form action="">
            <table id="myTable" class="tablesorter">
                ...
                <tr>
                    ...
                    <th style="width:13%">تعداد بازدید</th>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" />
                        <a href="<?php echo "news/edit.php?id=$rows[id]"?>"><img src="pics/pencil.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/pencil.gif" width="16" height="16" alt="edit" /></a>
                        <a href="<?php echo "news/delete.php?id=$rows[id]"?>"><img src="pics/bin.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/bin.gif" width="16" height="16" alt="delete" /></a>
                    </td>
                </tr>
    ...
    <center><a href="news/insert.php"><input value="ایجاد خبر جدید" type="submit"/></a></center>
    <br>
    <?php
