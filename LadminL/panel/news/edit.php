...
if(isset($_POST['send']))
{
    ...
    if ($filename !="")
    {
        ...
        $result=$connect->prepare("UPDATE `tbl_news` SET title=:title,context=:text,image=:file WHERE id=:id");
        ...
        $file='e7e391f15e9a26148b572ec53c6a32e2l.jpg';
        $r=$connect->prepare("UPDATE `tbl_news` SET title=:title,context=:text,image=:file WHERE id=:id");
        $r->execute(array(
            ":id"=>$_GET['id'],
            ":title"=>$_POST['title'],
            ":text"=>$_POST['context'],
            ...
            <div class="grid_12">
                <div id="logo">
                    <ul id="nav">
                        ...
                        <li id="current"><a href="news.php">ایجاد خبر جدید</a></li>
                        <li id="current"><a href="">ایجاد اموزش جدید</a></li>
                        <li id="current"><a href="../admin.php">تنظیمات کاربری</a></li>
                        <li id="current"><a href="">تنظیمات کلی</a></li>
                    </ul>
                </div><!-- End. #Logo -->
            </div><!-- End. .grid_12-->
            <div style="clear: both;"></div>
...
<center><div style="width:700px;">
        ...
        if (isset($_GET['id']))
        {
        $re=$connect->prepare("SELECT * FROM `tbl_news` WHERE id=:id");
        $re->execute(array(
            ":id"=>$_GET['id']
        ));
        ...
        ?>
            <textarea cols="10" rows="5" name="title"><?php echo $row['title'];?></textarea>
            <?php
            }
            else
            {
            ...
            <br>
            <textarea name="context" cols="200" rows="25" id="editor1"><?php echo $row['context'];?></textarea>
            <br>
