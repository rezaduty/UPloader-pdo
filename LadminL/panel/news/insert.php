...
if(isset($_POST['send']))
{
    ...
    if ($filename !="")
    {
        ...
        move_uploaded_file($_FILES['file'] ['tmp_name'],"../../../up/news/".$file);
        $result=$connect->prepare("INSERT INTO `tbl_news`(title,context,image) VALUES(:title,:text,:file)");
...
<div id="header">
            ...
            <div class="grid_12">
                <div id="logo">
                    <ul id="nav">
                        ...
                        <li id="current"><a href="">تنظیمات کاربری</a></li>
    ...
    <center><div style="width:700px;">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <textarea cols="10" rows="5" name="title"></textarea>

            <br>
            <input type="file" name="file" placeholder="تصویر مورد نظر خود را وارد کنید">
            <br>
            <textarea name="content" cols="200" rows="25" id="editor1"></textarea>
            <br>
